...
public abstract class ConstraintSpaceAction extends PlatformKitAction {
	 ...
	 */
	protected Command createAddConstraintSetCommand(EList constraintSets) {
	 ...
	 */
	protected Command createRemoveConstraintSetCommand(EList constraintSets) {
		Assert.isNotNull(editingDomain);
		Assert.isNotNull(space);
		Assert.isNotNull(constraintSets);
	 ...
	 */
	protected Command createAddOntologyCommand(EList ontologies) {
		Assert.isNotNull(editingDomain);
		Assert.isNotNull(space);
