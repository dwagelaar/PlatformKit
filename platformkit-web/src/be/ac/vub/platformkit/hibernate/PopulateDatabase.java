...
public class PopulateDatabase {
     ...
     * @throws IOException
     */
    public void registerKnownPlatform(String currentOntName, InputStream ontology) throws IOException {
    	...
    	for (Enumeration e = knownPlatforms.propertyNames(); e.hasMoreElements();) {
    ...
    public Properties getKnownPlatforms() throws IOException {
    	if (knownPlatforms == null) {
        	...
        	final URL url = PopulateDatabase.class.getResource("KnownPlatforms.properties.xml");
