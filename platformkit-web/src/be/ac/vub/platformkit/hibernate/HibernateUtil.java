    ...
    private static SessionFactory createSessionFactory() {
        ...
        try {
        	...
        	if (connectionUsername != null) {
            	...
            	cfg.setProperty("hibernate.connection.username", connectionUsername);
        	}
        	if (connectionPassword != null) {
        		logger.info("Overriding hibernate.connection.password value");
            	cfg.setProperty("hibernate.connection.password", connectionPassword);
        	}
        	if (hbm2ddlAuto != null) {
            ...
            logger.log(Level.SEVERE, "Initial SessionFactory creation failed." + ex.getLocalizedMessage(), ex);
