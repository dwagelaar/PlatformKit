...
protected static final java.util.regex.Pattern quotes = Pattern.compile("'");
...
List ps = session.createQuery("from " + PlatformDescription.class.getCanonicalName() + " where browserID=" + "'" + m.replaceAll(escapedQuote) + "'").list();
