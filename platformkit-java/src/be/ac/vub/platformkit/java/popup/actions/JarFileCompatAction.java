...
public class JarFileCompatAction extends CompatAction {
	...
	public class JarFileCompatActionRunner extends CompatActionRunner {
		...
		public void loadDepsModel(IProgressMonitor monitor)
			...
			final IFile jarFile = (IFile)((IStructuredSelection) selection).getFirstElement();
	...
	protected void runAction(IProgressMonitor monitor) throws Exception {
        ...
        JarFileCompatActionRunner runner = new JarFileCompatActionRunner();
